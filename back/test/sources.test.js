...
test('expõe Congresso, tribunais, CARF e administração fiscal', async (context) => {
  ...
  assert.ok(['receita-cosit', 'receita-in', 'receita-notas', 'nfe-notas-tecnicas', 'sped-notas-tecnicas', 'stj-informativos', 'stf-informativos', 'pgfn-pareceres', 'pgfn-noticias', 'carf-noticias'].every((id) => ids.includes(id)));
