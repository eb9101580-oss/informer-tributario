export const officialSources = [
  ...
  },
  {
    ...
    discoveryUrl: 'https://normas.receita.fazenda.gov.br/sijut2consulta/consulta.action',
    focus: ['Soluções de Consulta', 'Soluções de Divergência', 'COSIT'], monitoring: 'A cada 6 horas', priority: 2, color: 'blue', adapter: 'receita-normas',
  },
  {
    ...
    url: 'https://normas.receita.fazenda.gov.br/sijut2consulta/consulta.action',
    discoveryUrl: 'https://normas.receita.fazenda.gov.br/sijut2consulta/consulta.action',
    focus: ['Instruções Normativas', 'Atos Declaratórios', 'Obrigações acessórias'], monitoring: 'A cada 6 horas', priority: 3, color: 'gold', adapter: 'receita-normas',
  },
  {
    ...
    url: 'https://normas.receita.fazenda.gov.br/sijut2consulta/consulta.action',
    discoveryUrl: 'https://normas.receita.fazenda.gov.br/sijut2consulta/consulta.action',
    focus: ['Notas', 'Pareceres', 'Orientações'], monitoring: 'A cada 6 horas', priority: 4, color: 'gold', adapter: 'receita-normas',
  },
  {
  ...
  },
  {
    ...
    url: 'https://www.gov.br/carf/pt-br/jurisprudencia/acordaos-carf', discoveryUrl: 'https://acordaos.economia.gov.br/solr/acordaos2/select',
    focus: ['Acórdãos', 'Súmulas', 'Resoluções'], monitoring: 'A cada 6 horas', priority: 10, color: 'gold', adapter: 'carf-solr',
  },
  {
