...
export const api = {
  ...
  createUser: (payload) => request('/admin/users/invite', { method: 'POST', body: JSON.stringify(payload) }),
  resetUserPassword: (id, password) => request(`/admin/users/${encodeURIComponent(id)}/password`, { method: 'POST', body: JSON.stringify({ password }) }),
