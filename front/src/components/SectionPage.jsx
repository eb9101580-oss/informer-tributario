...
export function SectionPage({ sectionId, onOpen, onFeedback, feedbackFor }) {
  ...
  return (
    <section className="section-page">
      ...
      {!feed.length && <div className="empty-state"><ArrowUpRight size={28} /><h3>Nenhuma publicação do último mês</h3><p>As fontes estão cadastradas e aparecerão após o próximo ciclo de varredura.</p></div>}
    </section>
  );
}
