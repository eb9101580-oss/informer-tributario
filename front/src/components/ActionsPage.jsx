      ...
      <div className="tracked-actions-list">
        {sortedItems.map((item) => (
          <article className="tracked-action" key={item.id}>
            ...
            {item.court === 'stf' && (item.classNumber || item.theme) && <p className="tracked-action__query">Processo no STF: <strong>{item.classNumber || 'Incidente consultado'}</strong>{item.theme ? ` · Tema ${item.theme}` : ''}</p>}
